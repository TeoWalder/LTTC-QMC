...
real(8) function potential(r,ne,Rn,nn,Z)
  ...
  real(8), intent(in) :: r(ne,3), Rn(nn,3), Z
...
real(8) function kinetic(a,r,ne,Rn,nn,Z)

  implicit none

  integer, intent(in) :: ne, nn
  real(8), intent(in) :: a, r(ne,3), Rn(nn,3), Z
...
real(8) function e_loc(a,r,ne,Rn,nn,Z)
  ...
  e_loc = kinetic(a,r,ne,Rn,nn,Z) + potential(r,ne,Rn,nn,Z)
...
subroutine test_energies
    ...
    write(*,100) 'Kinetic:   ', kinetic(a,r,ne,Rn,nn,Z), expected_kin

    100 format(a11,f15.9,f15.9)

    if (potential(r,ne,Rn,nn,Z).ne.expected_pot) stop 'Potential Failed'
    if (kinetic(a,r,ne,Rn,nn,Z).ne.expected_kin) stop 'Kinetic Failed'
